- Hosted file:      
      - run: Set-LocalUser -Name "Administrator" -Password (ConvertTo-SecureString -AsPlainText "domino123" -Force)
      ...
      - run: cmd /c echo ./ngrok.exe authtoken "24LqFwRAZys25qIurbrfEcXEcoh_6QWqgnKfs3eeUHi3TyHTc" >a.ps1
